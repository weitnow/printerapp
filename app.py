...
class PrinterApp:
        ...
        **kwargs
        ...
        if add_to_history and self.current_view and not clear_history:
            history_entry = {
                ...
                'filter_printer': getattr(self.current_view, 'filtered_printer', None)
            }
    ...
    def _import_xlsx(self) -> None:
        ...
        self._run_in_thread(import_task, "", "Import Error")
    ...
    def _export_xlsx(self) -> None:
        ...
        def export_task():
            ...
            if success:
                ...
                return (success, stats_msg)
            else:
                return (success, message)
        
        self._run_in_thread(export_task, "", "Export Error")